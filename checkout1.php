                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="nav-item"> <a class="nav-link active" href="restaurants.php">Cloud Kitchen's <span class="sr-only"></span></a> </li>
            ...
            <div class="top-links">
                <div class="container">
                    <ul class="row links">
                        ...
                        <li class="col-xs-12 col-sm-4 link-item"><span>1</span><a href="restaurants.php">Choose Cloud Kitchen's</a></li>
                                        ...
                                        <ul class=" list-unstyled">
                                            ...
                                            <li>
                                                <label class="custom-control custom-radio  m-b-10">
                                                    <input name="mod"  type="radio" value="Online" disabled class="custom-control-input"> <span class="custom-control-indicator"></span> <span class="custom-control-description">Online <img src="images/gp.png" alt="" width="90"></span> </label>
                                            </li>
                                        </ul>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-xs-12 col-sm-3 payment-options color-gray">
                                    ...
                                    <ul>
                                <li>
                                    <a href="#"> <img src="images/phonepe.png" alt="PhonePe"> </a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="#"> <img src="images/upi.png" alt="UPI"> </a>
                                </li>
                                ...
                                <div class="col-xs-12 col-sm-4 address color-gray">
                                    <h5>Address</h5>
                                    <p>Near Sakhre Petrolium, Uruli Kanchan,Pune.</p>
                                    <h5>Phone: 7028059997</a></h5> </div>
